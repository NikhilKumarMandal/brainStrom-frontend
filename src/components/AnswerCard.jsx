...
export default function AnswerCard({ answer }) {
  ...
  return (
    <div className="rounded-xl p-4 mx-6 bg-gray-800 text-gray-200 shadow-md transition">
      ...
      <div className="w-[97%] mx-auto mt-3 flex justify-between items-center text-sm text-gray-400">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            {userVote === "UPVOTE" ? <BiSolidUpvote /> : <BiUpvote />}
          ...
          >
            {userVote === "DOWNVOTE" ? <BiSolidDownvote /> : <BiDownvote />}
