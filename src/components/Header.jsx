  ...
  return (
    <div className="w-[90%] text-white py-4  flex justify-between items-center self-center relative">
      ...
      <button
        ...
        className="focus:outline-none bg-transparent hover:border-none"
      >
        <img
          src={getRandomImage()}
          alt="Profile"
      ...
      {menuOpen && (
        <div className="absolute top-full right-0 mt-2 w-40 bg-gray-700 rounded-lg z-10">
          <button
            ...
            className="block w-full text-left px-4 py-2 text-white hover:bg-gray-700 hover:border-none"
          >
            Logout
          </button>
        </div>
