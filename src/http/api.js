...
export const getAllTicket = () => {
  api.get("/ticket/getAllTicket");
}

export const getTicketById = (id) => {
  api.get(`/ticket/getTicket/${id}`);
}
...
export const getNotice = (teamId) => {
  api.get(`/notice/${teamId}`);
}
